...
filesToCopy.forEach(({ src, dest }) => {
  ...
  if (fs.existsSync(srcPath)) {
    ...
    console.warn(`⚠ Warning: ${src} not found, creating placeholder`);
    const placeholder = `/* placeholder ${src} - generated by build script */\n`;
    fs.writeFileSync(destPath, placeholder, 'utf8');
    console.log(`✓ Created placeholder for ${dest}`);
  }
});
