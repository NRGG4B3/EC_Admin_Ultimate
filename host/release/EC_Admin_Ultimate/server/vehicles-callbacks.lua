...
-- ============================================================================
-- GET ALL VEHICLES FOR SPAWNING
-- ============================================================================

lib.callback.register('ec_admin:getAllVehicles', function(source, data)
    -- Return default vehicle list + any custom packs loaded
    local vehicleList = {
        -- Default GTA vehicles (common spawnable ones)
        -- This would ideally come from a vehicles.lua config file
        ...
        -- ... Add more as needed from your vehicles config
    }
    
    -- TODO: Load from vehicles.lua or database
