...
local function HandleSetupBuildUI(data)
    ...
    -- Building UI at runtime is not supported; UI is built during resource packaging
    local message = 'Runtime UI build is not supported. Use the provided setup.bat/build pipeline.'
