...
-- Callback: Get economy data (direct fetch from UI)
RegisterNUICallback('economy:getData', function(data, cb)
    local timeRange = data.timeRange or '24h'
    
    -- Get all players wealth
...
-- Callback: Get server settings (direct fetch from UI)
