...
CreateThread(function()
    ...
    MySQL.Sync.execute([[
        CREATE TABLE IF NOT EXISTS ec_kicks (
            id INT AUTO_INCREMENT PRIMARY KEY,
            player_id VARCHAR(50) NOT NULL,
            player_name VARCHAR(100) NOT NULL,
            admin_id VARCHAR(50) NOT NULL,
    ...
    MySQL.Sync.execute([[
        CREATE TABLE IF NOT EXISTS ec_mutes (
            id INT AUTO_INCREMENT PRIMARY KEY,
            player_id VARCHAR(50) NOT NULL,
            player_name VARCHAR(100) NOT NULL,
            admin_id VARCHAR(50) NOT NULL,
    ...
    MySQL.Sync.execute([[
        CREATE TABLE IF NOT EXISTS ec_mod_actions (
            id INT AUTO_INCREMENT PRIMARY KEY,
            admin_id VARCHAR(50) NOT NULL,
            admin_name VARCHAR(100) NOT NULL,
    ...
    Logger.Debug('Moderation tables initialized')
end)
