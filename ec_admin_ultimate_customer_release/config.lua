...
-- ============================================================================
--  ✅ WHITELIST CONFIGURATION (OFF by default for customers)
-- ============================================================================

Config.Whitelist = {
    enabled = false,  -- Whitelist is OFF by default for customers
    requireApproval = false,
    autoApprove = false,
    discordRoleId = '',  -- Discord role ID for whitelist (if using role-based)
